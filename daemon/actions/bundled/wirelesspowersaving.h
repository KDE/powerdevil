...
private:
    ...
    PowerDevilEnums::WirelessMode m_currentProfileWifiOption;
    PowerDevilEnums::WirelessMode m_currentProfileWwanOption;
    PowerDevilEnums::WirelessMode m_currentProfileBtOption;

    // Options for previous profile
    PowerDevilEnums::WirelessMode m_lastProfileWifiOption;
    PowerDevilEnums::WirelessMode m_lastProfileWwanOption;
    PowerDevilEnums::WirelessMode m_lastProfileBtOption;
