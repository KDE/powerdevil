...
struct BacklightSysfsDevice {
    ...
    int readInt(const QLatin1StringView property) const;
    int readBrightness() const; // or -1 if unavailable
    ...
    static int readInt(const QString &syspath, const QLatin1StringView property);
};
